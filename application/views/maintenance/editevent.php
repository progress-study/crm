            ...
            <div class="card-body">
              ...
              <form action="<?php echo base_url().'index.php/eventscontroller/do_upload'; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="event_name" placeholder="Event Name" value="<?php echo $eventrow->event_name; ?>" required>
                </div>
                <div class="mb-3">
                  <label for="amount" class="form-label">Event Date</label>
                  <input type="date" class="form-control" name="event_date" value="<?php echo $eventrow->event_date; ?>" required>
                </div>
                <div class="mb-3">
                  <label for="amount" class="form-label">Event Time</label>
                  <input type="time" class="form-control" name="event_time" value="<?php echo $eventrow->event_time; ?>" required>
                </div>
                <div class="mb-3">
                  <label for="amount" class="form-label">Event Location</label>
                  <input type="text" class="form-control" name="event_location" value="<?php echo $eventrow->event_location; ?>" placeholder="Event Location" required>
                </div>
                <div class="mb-3">
                  <label for="amount" class="form-label">Event Region</label>
                  <select class="form-control" name="event_region">
                    <option value='<?php echo $eventrow->region_id; ?>'><?php echo $eventrow->region_name; ?></option>
                    <?php
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="event_info" value="<?php echo $eventrow->event_info; ?>" placeholder="Region Description" required>
                </div>
                <div class="mb-3">
                  <label for="amount" class="form-label">Event Comments</label>
                  <input type="text" class="form-control" name="event_comments" value="<?php echo $eventrow->event_comments; ?>" placeholder="Region Description" required>
                </div>
                <div class="mb-3">
