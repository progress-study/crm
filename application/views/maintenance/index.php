        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><a href="newofficer">Add New Officer</a>&nbsp;&nbsp;&nbsp;<a href="newregionassign">Add New Region Assignment</a></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><a href="newofficer">Add Region</a></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
