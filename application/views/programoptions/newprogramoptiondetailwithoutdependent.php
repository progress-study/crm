        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="<?php echo base_url(); ?>index.php/saveprogramoptiondetailwithoutdependent" method="post">
                ...
                <div class="mb-3">
                  ...
                  <select name="type" class="form-control" required>
                    ...
                    <option option="Return Airfare (each)">Return Airfare (each)</option>
