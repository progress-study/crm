        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="<?php echo base_url(); ?>index.php/updateprogramoptiondetails" method="post">
                <?php
                  foreach($programoptionsdetails as $row) {
                ?>
                <input type="hidden" name="podid" value="<?php echo $podid; ?>">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="amountrequired" placeholder="Amount Required" value="<?php echo $row->amountrequired; ?>" required>
                </div>
                <div class="mb-3">
                  <label for="amount" class="form-label">Number of Family</label>
                  <input type="text" class="form-control" name="numberoffamily" placeholder="Number of Family" value="<?php echo $row->numberoffamily; ?>" required>
                </div>
                <div class="mb-3">
                  <label for="amount" class="form-label">Amount to Access</label>
                  <input type="text" class="form-control" name="amounttoaccess" placeholder="Amount to Access" value="<?php echo $row->amounttoaccess; ?>" required>
                </div>
                <div class="mb-3">
                  <label for="amount" class="form-label">Confirm Access to Funds</label>
                  <input type="text" class="form-control" name="confirmaccesstofunds" placeholder="Confirm Access to Funds" value="<?php echo $row->confirmaccesstofunds; ?>" required>
                </div>
