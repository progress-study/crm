    ...
    <div class="card px-1 py-4">
        ...
        <form action="saveclientform" method="POST" onsubmit="checkConfirmed(event)">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <!-- <label for="name">Name</label> --> <input class="form-control" type="text" name="middlename" placeholder="Middle Name" required> </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <!-- <label for="name">Name</label> --> <input class="form-control" type="text" name="noofchildren" placeholder="No. of Children" required> </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
